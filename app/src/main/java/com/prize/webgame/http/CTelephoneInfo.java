...
//	private String iNumeric2;// sim2 code number
    ...
    public boolean isDataConnected1() {
        if (TextUtils.equals(iDataConnected1, "2")
                || TextUtils.equals(iDataConnected1, "1"))
            return true;
        else
            return false;
    }
...
//	}
    ...
    void setCTelephoneInfo(String channel) {
...
//			if (JLog.isDebug) {
//				JLog.i("ClientInfo","setCTelephoneInfo---SystemProperties imei1="+imei1);
//			}
            CTelephoneInfo.imeiSIM1 = getOperatorBySlot(mContext,
                    "getDeviceIdGemini", 0);

            CTelephoneInfo.imeiSIM2 = getOperatorBySlot(mContext,
                    "getDeviceIdGemini", 1);

//			CTelephoneInfo.iNumeric1 = getOperatorBySlot(mContext,
//					"getSimOperatorGemini", 0);
//			CTelephoneInfo.iNumeric2 = getOperatorBySlot(mContext,
//					"getSimOperatorGemini", 1);
            CTelephoneInfo.iDataConnected1 = getOperatorBySlot(mContext,
                    "getDataStateGemini", 0);
            CTelephoneInfo.iDataConnected2 = getOperatorBySlot(mContext,
                    "getDataStateGemini", 1);
        } catch (GeminiMethodNotFoundException e) {
            e.printStackTrace();
            Log.i("ClientInfo", "GeminiMethodNotFoundException-" + e.getMessage());
            try {
                CTelephoneInfo.imeiSIM1 = getOperatorBySlot(mContext,
                        "getDeviceId", 0);
                CTelephoneInfo.imeiSIM2 = getOperatorBySlot(mContext,
...
//						"getSimOperator", 1);
                ...
                // you wish
                e1.printStackTrace();
                Log.i("ClientInfo", "GeminiMethodNotFoundException2-" + e1.getMessage());
            }
        }

        /*if (!TextUtils.isEmpty(channel) && ("koobee".equals(channel) || "coosea".equals(channel)) && TextUtils.isEmpty(CTelephoneInfo.imeiSIM1) && TextUtils.isEmpty(CTelephoneInfo.imeiSIM2)) {
            CTelephoneInfo.imeiSIM1 = SystemProperties.get("gsm.mtk.imei1");
            CTelephoneInfo.imeiSIM2 = SystemProperties.get("gsm.mtk.imei2");
        }*/
        ...
        try {
            CTelephoneInfo.isSIM1Ready = getSIMStateBySlot(mContext,
                    "getSimStateGemini", 0);
            CTelephoneInfo.isSIM2Ready = getSIMStateBySlot(mContext,
                    "getSimStateGemini", 1);
        } catch (GeminiMethodNotFoundException e) {
            e.printStackTrace();
            try {
